          ...
          {method === 'phone' ? (
            step === 'input' ? (
              <form onSubmit={handlePhoneSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold py-3 rounded-xl hover:from-orange-600 hover:to-red-700 transition-all flex items-center justify-center gap-2"
                >
                  Send OTP
